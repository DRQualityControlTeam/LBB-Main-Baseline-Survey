...
import delimited "Non VI\UNICEF_LBB-Non-Visually_Impaired_Learners_Only_Field-1772990008174.csv", case(preserve)
...
*Corrections
replace number_discrimination_gridgridAu= 0 if interview_ID == "a3e3625b-8046-4a6c-8e61-4ce6ac6a3fda"
foreach x in addition_grid_7	addition_grid_8	addition_grid_9	addition_grid_10{
	replace `x' = . if interview_ID =="2af04f5f-3888-4d3d-81aa-c3230b8cf393"
}
foreach x in subtraction_grid_6	subtraction_grid_7	subtraction_grid_8	subtraction_grid_9	subtraction_grid_10{
	replace `x' = . if interview_ID =="2af04f5f-3888-4d3d-81aa-c3230b8cf393"
}
replace subtraction_gridnum_att = 5 if interview_ID =="2af04f5f-3888-4d3d-81aa-c3230b8cf393"
...
cap export excel $var_kept Duration_mins issue_comment using "LBB UNICEF issues NON-VIs ${dates} v01.xlsx", sheet(duration_issues,replace)firstrow(variables)
restore
...
cap export excel $var_kept INT_STARTTIME INT_ENDTIME gap_mins issue_comment using "LBB UNICEF issues NON-VIs ${dates} v01.xlsx", sheet(lag_time_issues,replace)firstrow(variables)
restore
...
cap export excel $var_kept GPS* issue_comment using "LBB UNICEF issues NON-VIs ${dates} v01.xlsx", sheet(GPSaccuracy_issues,replace)firstrow(variables)
restore
...
keep if gps_dup> 0
cap export excel $var_kept GPS* issue_comment using "LBB UNICEF issues NON-VIs ${dates} v01.xlsx", sheet(gps_duplicates_issues,replace)firstrow(variables)
restore
...
cap export excel $var_kept issue_comment using "LBB UNICEF issues NON-VIs ${dates} v01.xlsx", sheet(Interv_dupl_gen_issues,replace)firstrow(variables)
restore
...
replace issue_comment ="The interviews have duplicates, kindly clarify"
keep if int_dup>0
cap export excel $var_kept int_dup issue_comment using "LBB UNICEF issues NON-VIs ${dates} v01.xlsx", sheet(Interv_dupl_main_issues,replace)firstrow(variables)
restore

*Age
preserve
replace issue_comment ="Age provided is way high or lower for the student, kindly clarify"
keep if !inrange(gap_mins,0,12)
cap export excel $var_kept issue_comment using "LBB UNICEF issues NON-VIs ${dates} v01.xlsx", sheet(Age_issues,replace)firstrow(variables)
restore
...
cap export excel $var_kept letter_sound_knowledge_1 -  letter_sound_knowledgenum_att issue_comment using "LBB UNICEF issues NON-VIs ${dates} v01.xlsx", sheet(Letter_knowledge_time_1,replace)firstrow(variables)
restore
...
cap export excel $var_kept letter_sound_knowledge_1 -  letter_sound_knowledgenum_att issue_comment using "LBB UNICEF issues NON-VIs ${dates} v01.xlsx", sheet(Letter_knowledge_time_2,replace)firstrow(variables)
restore
...
cap export excel $var_kept read_familiar_words_1 -  read_familiar_wordsnum_att issue_comment using "LBB UNICEF issues NON-VIs ${dates} v01.xlsx", sheet(read_familiar_time_1,replace)firstrow(variables)
restore
...
cap export excel $var_kept read_familiar_words_1 -  read_familiar_wordsnum_att issue_comment using "LBB UNICEF issues NON-VIs ${dates} v01.xlsx", sheet(read_familiar_time_2,replace)firstrow(variables)
restore
...
cap export excel $var_kept oral_reading_fluency_1 -  oral_reading_fluencynum_att issue_comment using "LBB UNICEF issues NON-VIs ${dates} v01.xlsx", sheet(oral_reading_time_1,replace)firstrow(variables)
restore
...
cap export excel $var_kept oral_reading_fluency_1 -  oral_reading_fluencynum_att issue_comment using "LBB UNICEF issues NON-VIs ${dates} v01.xlsx", sheet(oral_reading_time_2,replace)firstrow(variables)
restore
...
cap export excel $var_kept addition_grid_1 -  addition_gridautoStop issue_comment using "LBB UNICEF issues NON-VIs ${dates} v01.xlsx", sheet(addition_issue,replace)firstrow(variables)
restore
...
cap export excel $var_kept subtraction_grid_1 -  subtraction_gridgridAutoStopped issue_comment using "LBB UNICEF issues NON-VIs ${dates} v01.xlsx", sheet(subtraction_issue,replace)firstrow(variables)
restore
...
*Save for dashboard updating
keep interview_ID School CONSENT
drop if CONSENT == 0

export excel using "LBB Baseline for screener data NON-VIs.xlsx", sheetreplace firstrow(variables)
